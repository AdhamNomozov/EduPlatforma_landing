...
const tiers = [
  ...
  },
  {
    ...
    id: "tier-premium",
    price: "50M",
    description: "Maktablar va texnikumlar uchun.",
    features: [
      "3000 tagacha talaba",
      "Cheksiz kurslar",
      "SMS xabarnomalar",
      "Maxsus API integratsiyasi",
      "AI o'qituvchi funksiyasi",
  ...
  },
  {
    ...
    id: "tier-enterprise",
    price: "80M+",
    description: "Universitet va yirik tashkilotlar uchun maxsus ishlab chiqish.",
    features: [
      "Cheksiz talabalar",
